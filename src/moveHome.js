...
// 
// pawn entering home is (kinda) implemented in pawn.decrDistRemaining()
// moving into home row is implemented by board.getNextSpace()
// 
// pop the pawn from the player.pawns array
// reward a (minimove) bonus of 10
...
export class MoveHome extends Move {
  ...
  move(board) {
	...
	// check MoveHome consumes the proper roll, and that the move is allowed
